...
[^spike]: Base source spike, [local spike report](history-spike.md), dated 2026-09-18. Source-spike measurements must be distinguished from subsequent migrated-repository runs.
[^worker]: Base source spike, [historical execution worker protocol](history-worker.md), local report dated 2026-09-18.
