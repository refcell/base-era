...
`PATH` to compute Keccak-256 for malformed headers. The passed count excludes SKIP. The final
2026-09-18 summary in `etc/history-devnet/evidence/final/replay.json` records 95 PASS and no
FAIL/SKIP outcomes, including alternate-branch builder parity and canonical restoration. The six
